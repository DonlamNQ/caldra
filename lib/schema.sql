...
-- v2.21 : connexion TradeStation via OAuth — RETIRÉE (2026-06-29). Remplacée à terme par
-- Binance/Coinbase (crypto). L'API TradeStation ne fournit pas le P&L réalisé par ordre →
-- intégration abandonnée. La table créée par l'ancienne v2.21 est supprimée (jamais utilisée
-- en prod). À exécuter une fois dans le SQL Editor pour nettoyer.
drop table if exists tradestation_accounts;
