...
-- v2.24 : connexion Binance (clé API lecture seule, crypto spot) — RETIRÉE (2026-07-29).
-- Intégration supprimée (personne ne tradait sur Binance). ⚠️ À EXÉCUTER EN PROD.
drop table if exists binance_accounts cascade;
