...
- Early adopters −25 % à vie (Pro 14,25€ / Max 25,50€), **limité aux 25 premiers inscrits** : coupon Stripe `caldra-early-25-forever` (`duration: forever`, percent_off 25, max_redemptions 25) + code promo START25. Le champ "code promo" s'affiche au checkout.
...
1. Créer deux produits (Pro 19€/mois, Max 34€/mois) → copier les Price IDs dans `.env.local` et Vercel
...
### ✅ Stripe configuré
- Produits : Pro 19€/mois (`STRIPE_PRO_PRICE_ID`) + Max 34€/mois (`STRIPE_MAX_PRICE_ID`)
