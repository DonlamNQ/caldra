      ...
      <div style={{ width: '100%', maxWidth: 460 }}>
        ...
        <div style={{ background: C.card, border: `.5px solid ${C.b}`, borderRadius: 16, padding: '28px 26px', marginTop: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 6 }}>
            <div style={{ width: 40, height: 40, borderRadius: 9, background: C.va, border: `.5px solid ${C.vb}`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, fontWeight: 600, color: C.v, fontFamily: MONO }}>IBKR</div>
            <div>
