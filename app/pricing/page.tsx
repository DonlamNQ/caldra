        ...
        <div className="pricing-grid">
          <div className="plan-card plan-pro">
            ...
            <ul className="plan-features">
              ...
              <li><div className="pfc pfc-dim"><svg viewBox="0 0 12 12"><polyline points="2,6 5,9 10,3"/></svg></div>4 patterns r&eacute;currents</li>
          ...
          <div className="plan-card plan-max">
            ...
            <ul className="plan-features">
              ...
              <li className="plan-highlight"><div className="pfc pfc-red"><svg viewBox="0 0 12 12"><polyline points="2,6 5,9 10,3"/></svg></div><strong>R&egrave;gles configurables (on/off + seuils)</strong></li>
