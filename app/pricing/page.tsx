        ...
        <div className="pricing-grid">
          ...
          <div className="plan-card plan-max">
            ...
            <ul className="plan-features">
              ...
              <li className="plan-highlight"><div className="pfc pfc-red"><svg viewBox="0 0 12 12"><polyline points="2,6 5,9 10,3"/></svg></div><strong>D&eacute;brief de session</strong></li>
