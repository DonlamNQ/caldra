                  ...
                  {status.connected ? (
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <div>
                        ...
                        <div style={{ fontSize: 13, color: '#e2e8f0', fontFamily: "var(--font-geist-mono),monospace" }}>
                  ...
                  <div style={{ marginBottom: 16 }}>
                    <div style={STEP}>
                      ...
                      <div style={{ fontSize: 12, color: 'rgba(226,224,218,.5)', lineHeight: 1.6 }}>
                        Téléchargez le fichier <span style={{ color: '#e2e8f0', fontFamily: "var(--font-geist-mono),monospace" }}>CaldraBot.algo</span> ci-dessous et ouvrez-le dans cTrader via <span style={{ color: '#e2e8f0' }}>Automate → Open</span>.
                      </div>
                    </div>
                    <div style={STEP}>
