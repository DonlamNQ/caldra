...
const C_DARK = {
  ...
  bg: '#08080d', sf: '#0d0d1a', sf2: '#121228',
  b: 'rgba(255,255,255,.08)', b2: 'rgba(255,255,255,.13)', b3: 'rgba(255,255,255,.2)',
  tx: '#e2e8f0', tm: 'rgba(226,232,240,.95)', td: 'rgba(226,232,240,.6)', te: 'rgba(226,232,240,.35)',
  g: '#00d17a', o: '#ffab00',
}
const C_LIGHT = {
