...
// ── Palette ────────────────────────────────────────────────────────────────────
const C_DARK = {
  red: '#7c3aed', rd: 'rgba(124,58,237,.13)', rb: 'rgba(124,58,237,.30)', rg: 'rgba(124,58,237,.07)',
  bg: '#100f0d', sf: '#1a1916', sf2: '#232120',
  b: 'rgba(255,250,245,.08)', b2: 'rgba(255,250,245,.14)', b3: 'rgba(255,250,245,.23)',
  tx: '#f1eee8', tm: 'rgba(241,238,232,.88)', td: 'rgba(241,238,232,.58)', te: 'rgba(241,238,232,.40)',
  g: '#34d399', o: '#f5b13d',
  pnl: '#ece8e0',
}
const C_LIGHT = {
  red: '#7c3aed', rd: 'rgba(124,58,237,.09)', rb: 'rgba(124,58,237,.22)', rg: 'rgba(124,58,237,.05)',
  bg: '#ece8df', sf: '#faf7f0', sf2: '#f3efe6',
  b: 'rgba(45,38,25,.13)', b2: 'rgba(45,38,25,.21)', b3: 'rgba(45,38,25,.32)',
  tx: '#2a2620', tm: 'rgba(42,38,32,.90)', td: 'rgba(42,38,32,.62)', te: 'rgba(42,38,32,.46)',
  g: '#0f7a4e', o: '#b4530a',
  pnl: '#2e2a22',
}
