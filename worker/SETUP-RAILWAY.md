...
Ces workers de Caldra sont du **Node pur** (pas de MetaTrader, pas de Python) et
...
mais une commande de démarrage différente) : deux processus indépendants, si l'un
crashe l'autre continue.
